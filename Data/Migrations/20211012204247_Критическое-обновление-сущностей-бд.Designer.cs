...
namespace WebStore.Migrations
{
    ...
    [Migration("20211012204247_Критическое-обновление-сущностей-бд")]
    partial class Критическоеобновлениесущностейбд
    {
            ...
            modelBuilder.Entity("WebStore.Data.Entities.CartProduct", b =>
                {
                    ...
                    b.HasOne("WebStore.Data.Entities.ProductArticle", "Product")
                        .WithMany()
