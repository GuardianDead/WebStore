        ...
        public async ValueTask<bool> InitAsync(CancellationToken cancellationToken = default)
        {
            ...
            var orders = new Order[]
            {
                new Order(
                    ...
                    totalCost: selectedProducts[0].Aggregate(0,(sum, orderProduct) => sum + orderProduct.Product.Article.Model.Price) + deliveries[0].Cost,
                ...
                new Order(
                    ...
                    totalCost: selectedProducts[1].Aggregate(0, (sum, orderProduct) => sum + orderProduct.Product.Article.Model.Price) + deliveries[1].Cost,
                ...
                new Order(
                    ...
                    address: new Address(country: "Россия", region: "Владимирская область", city: "Муром", street: "Мечникова 55", postalCode: "602267"),
                    totalCost: selectedProducts[2].Aggregate(0, (sum, orderProduct) => sum + orderProduct.Product.Article.Model.Price) + deliveries[0].Cost,
                    trackNumber: "ZH3262363235WF",
